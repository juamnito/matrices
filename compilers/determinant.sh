...
if g++ -o executables/tests/determinant.exe tests/determinant.cpp objects/ob-src/* > logs/tests/Determinant-Log.txt 2>&1 ; then
    cat logs/tests/Determinant-Log.txt
